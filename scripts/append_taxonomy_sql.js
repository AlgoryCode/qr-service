const fs = require("fs");
const doc = JSON.parse(fs.readFileSync("src/main/resources/seed/menu-taxonomy.json", "utf8"));
...
const out = "src/main/resources/db/migration/V21__menu_taxonomy_and_tags.sql";
