...
UPDATE tbl_product SET name = 'QR Olusturma', description = 'QR kod olusturma hakki', scope_code = 'QR_CREATE_OWNER',
    unit_price = 4.00, vat_rate = 20.00, active = TRUE, consumable = TRUE, updated_at = NOW() WHERE code = 'QR_CREATE';
...
SELECT 'PRO_PACKAGE', 'Pro', '30 QR olusturma ve Akilli Asistan',
       '["30 QR olusturma hakki","Akilli Asistan","30 gun gecerlilik"]'::jsonb,
...
INSERT INTO tbl_plan_package (code, name, description, features, price, subtotal, vat_amount, currency, active, validity_days, trial_days, priority, purchasable, system_managed, trial_eligible, created_at, updated_at)
SELECT 'ULTIMATE_PACKAGE', 'Ultimate', '100 QR, Akilli Asistan, Akilli Ozet ve Akilli Raporlama',
       '["100 QR olusturma hakki","Akilli Asistan","Akilli Ozet","Akilli Raporlama","30 gun gecerlilik"]'::jsonb,
...
UPDATE tbl_plan_package SET
    name = 'Pro',
    description = '30 QR olusturma ve Akilli Asistan',
    features = '["30 QR olusturma hakki","Akilli Asistan","30 gun gecerlilik"]'::jsonb,
    price = 249.00,
    subtotal = 207.50,
    vat_amount = 41.50,
    currency = 'TRY',
...
UPDATE tbl_plan_package SET
    name = 'Ultimate',
    description = '100 QR, Akilli Asistan, Akilli Ozet ve Akilli Raporlama',
    features = '["100 QR olusturma hakki","Akilli Asistan","Akilli Ozet","Akilli Raporlama","30 gun gecerlilik"]'::jsonb,
    price = 649.00,
    subtotal = 540.83,
    vat_amount = 108.17,
    currency = 'TRY',
