-- Applies catalog-tiers seed (same as POST /admin/catalog/import?useClasspathSeed=true).
...
SELECT 'STARTER_PACKAGE', 'Baslangic', 'Kucuk kafeler ve tatlicilar icin operasyonel giris paketi',
...
UPDATE tbl_plan_package SET
    name = 'Baslangic', description = 'Kucuk kafeler ve tatlicilar icin operasyonel giris paketi',
