...
@Entity
@Table(name = "tbl_dashboard_user_session", indexes = {
        @Index(name = "idx_dashboard_user_session_user_id", columnList = "dashboard_user_id"),
        @Index(name = "idx_dashboard_user_session_revoked", columnList = "revoked")
})
@Getter
@Setter
@NoArgsConstructor
