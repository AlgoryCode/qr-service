...
public class ActiveTrialExtendHandler implements TrialExtendHandler {
    ...
    public Purchase extend(Long userId, TrialSnapshot snapshot, int days) {
        ...
        return trialPurchaseExtender.addDays(trial, days, PurchaseLogAction.TRIAL_EXTENDED);
    }
}
