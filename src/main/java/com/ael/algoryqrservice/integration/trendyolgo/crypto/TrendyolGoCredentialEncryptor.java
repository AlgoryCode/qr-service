...
@Component
public class TrendyolGoCredentialEncryptor {
    ...
    public TrendyolGoCredentialEncryptor(TrendyolGoProperties properties) {
    ...
    public String encrypt(String plaintext) {
        ...
        try {
            ...
            throw new IllegalStateException("TGO kimlik bilgisi şifrelenemedi", exception);
        }
    }
    ...
    public String decrypt(String ciphertext) {
        ...
        try {
            ...
            throw new IllegalStateException("TGO kimlik bilgisi çözülemedi", exception);
        }
    }
