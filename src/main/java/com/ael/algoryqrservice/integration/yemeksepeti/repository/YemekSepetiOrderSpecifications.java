...
public final class YemekSepetiOrderSpecifications {

    private YemekSepetiOrderSpecifications() {
    }

    public static Specification<YemekSepetiOrder> forConnectionListed(
            Long connectionId,
